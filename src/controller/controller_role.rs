...
pub async fn get_role(id: i32) -> crate::GenericResult<impl Reply> {
    controller_common::generate_response(dao_role::get_by_id(id).await)
}

pub async fn get_all_roles() -> crate::GenericResult<impl Reply> {
    controller_common::generate_response(dao_role::get_all().await)
}

pub async fn insert_role(json_data: serde_json::Value) -> crate::GenericResult<impl Reply> {
    controller_common::generate_response(dao_role::create(json_data).await)
}
...
pub async fn update_role(
    ...
    controller_common::generate_response(dao_role::update(id, json_data).await)
}

pub async fn delete_role(id: i32) -> crate::GenericResult<impl Reply> {
    controller_common::generate_response(dao_role::delete(id).await)
}
